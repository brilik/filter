<section class="collection collection--home page__collection-1">
    <div class="collection__container">
        <h2 class="collection__title">Offers of the week</h2>
        <div class="collection__items">
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-p6qcvttl1" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-f88zd5qkd" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-snrv6pj6u" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-q2n3rseix" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-7rdv81mcv" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-8xjxkn33k" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-5gzdtjneq" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
            <div class="collection__item">
                <div class="card">
                    ...
                    <form class="card__form" action="#">
                        <div class="field field--type-spinner card__quantity">
                            <div class="field__field"><button class="field__minus" type="button"></button><input class="js-only-numbers" type="text" name="quantity" id="spinner-d7za9dadr" /><button class="field__plus" type="button"></button></div>
                        </div><button class="button card__button-cart button--red" type="submit">Add to Cart</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="collection__nav"><button class="collection__prev" type="button"></button>
            <div class="collection__counter"><span class="collection__counter-current">1</span> of <span class="collection__counter-total">1</span></div><button class="collection__next" type="button"></button>
        </div>
    </div>
</section>